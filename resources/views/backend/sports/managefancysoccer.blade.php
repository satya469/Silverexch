  ...
  <div class="col-md-12 main-container">
    <div class="listing-grid">
      <div class="detail-row">
        <h2 class="d-inline-block">Manage Fancy</h2>
      </div>
      <a href="{{ route('admin.manage_fancy.cricket')}}" class="btn " style="margin: 5px;">Cricket</a>
      <a href="{{ route('admin.manage_fancy.soccer')}}" style="margin: 5px;" class="btn btn-primary">Soccer</a>  
          ...
          <table id="clientListTable" class="table table-striped table-bordered dataTable no-footer" style="width:100%" role="grid" aria-describedby="clientListTable_info">
            ...
            <tbody>
              ...
              <tr role="row" class="even">
                ...
                <td>
                  <a href="{{ route('admin.manage_fancy.soccersingle',$match->match_id) }}"> Manage Fancy</a>
                </td>
              </tr>
              @endforeach
