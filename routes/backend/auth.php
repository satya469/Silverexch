...
//        Route::get('admin', [AdminLoginController::class, 'showAdminLoginForm'])->name('admin-login');
//        Route::get('/', [AdminLoginController::class, 'showAdminLoginForm'])->name('adminlogin');
...
Route::group([
    ...
    'as' => 'auth.',
    'namespace' => 'Auth',
    'middleware' => ['role:administrator|admin|subadmin|supermaster|master'],
], function () {
    // User Management
