    ...
    <div class="col-sm-12">
        <table class="table" id="deposite">
            ...
            <tr>
                <th>Amount</th>
                <td colspan="2">
                    <input class="form-control numberOnly" type="number" onkeyup="depositeCal(this);" id="amount" name="amount" 
                           value="">
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td colspan="2">
                    <input class="form-control" type="password" id="m_pwd" name="m_pwd" 
                           value="">
                    <input type="hidden" id="balanceType" name="deposite_user_id" value="DEPOSIT">
                    <input type="hidden" id="uuidDep" name="deposite_user_id" value="{{$depositeUser->uuid}}">
                    <input type="hidden" id="deposite_user_id" name="deposite_user_id" value="{{$depositeUser->id}}">
                    <input type="hidden" id="withdrawal_user_id" name="withdrawal_user_id" value="{{$loginUser->id}}">
                </td>
            </tr>
        </table>
    </div> 
