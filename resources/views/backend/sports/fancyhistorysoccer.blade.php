...
<div class="row">
  <div class="col-md-12 main-container">
    <div class="listing-grid">
      ...
      <a href="{{ route('admin.fancy_history.cricket')}}" class="btn " style="margin: 5px;">Cricket</a>
      <a href="{{ route('admin.fancy_history.soccer')}}" style="margin: 5px;" class="btn btn-primary">Soccer</a>  
          ...
          <table id="clientListTable" class="table table-striped table-bordered dataTable no-footer" style="width:100%" role="grid" aria-describedby="clientListTable_info">
            ...
            <tbody>
              ...
              <tr role="row" class="even">
                ...
                <td>
                  <a href="{{ route('admin.manage_history.soccersingle',$match->match_id) }}">Fancy History</a>  
                </td>
              </tr>
              @endforeach
