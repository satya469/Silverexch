      ...
      <div class="coupon-card">
         <div class="game-heading"> 
          ...
          <script src="https://demo.nanocosmos.de/nanoplayer/api/release/nanoplayer.4.min.js?20200302"></script>
            ...
            <div class="cardsDiv">
                <span class="Team0">
                    <b id="cardunderName">Player A</b>
                    <span class="card1"></span>
                    <span class="card2"></span>
                </span>
                <span style="margin-left: 10px;" class="Team1">
                    <b>Player B</b>
                  <span class="card1"></span>
                  <span class="card2"></span>
                </span><br>
                <div class="Team2">
                  ...
                  <span class="card4"></span>
                  <span class="card5"></span>
                </div>
            </div>
              ...
              <div data-title="OPEN" class="table-body ODDS">
                <div data-title="ACTIVE" class="table-row oddsTot oddssteam0">
                  <div class="float-left country-name box-4">
                    ...
                    <p>
                        <span class="float-left" style="color: black;"></span> 
                        <span class="float-right" style="display: none; color: black;"></span>
                    </p>
                  </div>
  ...
  var player;
        var config={"source":{"h5live": {
            "rtmp": {
                ...
                "streamname": "zWo7p-dFgz2","type":"live"
            },
            "server": {
...
<script>
  ...
  function getData(){
    $.ajax({
      ...
      cache: false,
      async: false, 
      data : "gameName=Poker&sportID={{$sports->id}}&_token={{csrf_token()}}",
      success: function(data){
        setDetails(data.detail,'Poker');
        setodd(data.runner,'Poker');
        setResult(data.result,'Poker');
        getBetsList();
      }
    });
