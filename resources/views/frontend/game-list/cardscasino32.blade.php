   ...
   var player;
        var config={"source":{"h5live": {
            "rtmp": {
                ...
                "streamname": "zWo7p-EBZ5L","type":"live"
            },
            "server": {
...
//      $(this).css('border','2px solid #000');
  ...
  function getData(){
    $.ajax({
      ...
      cache: false,
      async: false, 
      data : "gameName=CardScasin032&sportID={{$sports->id}}&_token={{csrf_token()}}",
      success: function(data){
       setDetails(data.detail,'CardScasin032');
        setodd(data.runner,'CardScasin032');
        setResult(data.result,'CardScasin032');
