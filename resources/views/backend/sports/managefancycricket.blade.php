...
<div class="row">
  <div class="col-md-12 main-container">
    <div class="listing-grid">
      ...
      <a href="{{ route('admin.manage_fancy.cricket')}}" class="btn btn-primary" style="margin: 5px;">Cricket</a>
      <a href="{{ route('admin.manage_fancy.soccer')}}" style="margin: 5px;" class="btn ">Soccer</a>    
          ...
          <table id="clientListTable" class="table table-striped table-bordered dataTable no-footer" style="width:100%" role="grid" aria-describedby="clientListTable_info">
            ...
            <tbody>
              ...
              <tr role="row" class="even">
                ...
                <td>
                  <a href="{{ route('admin.manage_fancy.single',$match->match_id) }}"> Manage Fancy</a>
                </td>
              </tr>
              @endforeach
