    ...
    public function create(array $data): User
    {
        return DB::transaction(function () use ($data) {
            $user = $this->model::create([
                ...
                'city' => $data['city'],
                'phone' => $data['phone'],
                'credit_ref' => (empty($data['credit_ref']) ? 0 :$data['credit_ref']),
                'exposelimit' => (empty($data['exposelimit']) ? 0 :$data['exposelimit']),
                'commission_cricket' => $data['commission_cricket'],
                'commission_football' => $data['commission_football'],
                'commission_tennic' => $data['commission_tennic'],
                'partnership_cricket' => $data['partnership_cricket'],
                'partnership_football' => $data['partnership_football'],
                'partnership_tennic' => $data['partnership_tennic'],
                'minbet_cricket' => $data['minbet_cricket'],
                'maxbet_cricket' => $data['maxbet_cricket'],
                'delay_cricket' => $data['delay_cricket'],
                'minbet_football' => $data['minbet_football'],
                'maxbet_football' => $data['maxbet_football'],
                'delay_football' => $data['delay_football'],
                'minbet_tennic' => $data['minbet_tennic'],
                'maxbet_tennic' => $data['maxbet_tennic'],
                'delay_tennic' => $data['delay_tennic'],
                'isChangePassParent' => 1,
                'partnership'=>$data['partnership_cricket'],
            ]);
