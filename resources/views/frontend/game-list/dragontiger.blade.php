          ...
          <div class="markets mobileodds">
            ...
            <div class="main-market  rootClass">
              ...
              <div class="table-header">
                 <div class="float-left country-name box-4 min-max mbox-4"><b></b></div>
              ...
              <div data-title="OPEN" class="table-body ODDS">
                <div data-title="ACTIVE" class="table-row oddsTot oddssteam0">
                  ...
                  <div class="box-1 back float-left back lock text-center font-size-14 mbox-1">
                      <span class="odd d-block back1t">1.98</span>
                      <span class="oddk d-block back1k">10000</span>
                  </div>
                ...
                <div data-title="ACTIVE" class="table-row oddsTot oddssteam1">
                  <div class="float-left country-name box-4 mbox-4">
                    <span class="oddteamname2 team-name1"><b class="teamName">Tiger</b></span>
                    <p>
                        <span class="float-left matchValClear matchValClearProfit" style="color: black;">0</span>
                        <span class="float-right matchValClearProfit" style="display: none; color: black;">0</span>
                    </p>
                  ...
                  <div class="float-left country-name box-4 mbox-4">
                    <span class="oddteamname2 team-name2"><b class="teamName">Tie(Rank Only)</b></span>
                    <p>
                        <span class="float-left matchValClear matchValClearProfit" style="color: black;">0</span>
                        <span class="float-right matchValClearProfit" style="display: none; color: black;">0</span>
                    </p>
                  ...
                  <div class="box-1 back float-left back lock text-center font-size-14 mbox-1">
                      <span class="odd d-block back1t">11</span>
                      <span class="oddk d-block back1k">10000</span>
                  </div>
                  <div class="box-1 lay float-left text-center font-size-14 mbox-1">
                      <span class="odd d-block lay1t"></span>
                ...
                <div data-title="ACTIVE" class="table-row oddsTot oddssteam3">
                  <div class="float-left country-name box-4 mbox-4">
                    <span class="oddteamname3 team-name3"><b class="teamName">Suited Tie</b></span>
                    <p>
                        <span class="float-left matchValClear matchValClearProfit" style="color: black;">0</span>
                        <span class="float-right matchValClearProfit" style="display: none; color: black;">0</span>
                    </p>
                  ...
                  <div class="box-1 back float-left back lock text-center font-size-14 mbox-1">
                      <span class="odd d-block back1t">50</span>
                      <span class="oddk d-block back1k">10000</span>
                  </div>
                  <div class="box-1 lay float-left text-center font-size-14 mbox-1">
                      <span class="odd d-block lay1t"></span>
...
<script>
    var player;
        var config={"source":{"h5live": {
            "rtmp": {
                "url": "http://176.58.120.211/diamond_teen_patti_tv/20_20_dragon_tiger",
...
//  $( document ).ready(function() {
//    setInterval(function(){ getBetsList(); }, 1000);
//  });
  $( document ).ready(function() {
