...
<!--<body class="app header-fixed sidebar-fixed aside-menu-off-canvas sidebar-lg-show">-->
    ...
    <div class="app-body" style="">
        ...
        <main class="main">
            ...
            <div id="clientDetailsTab">
            @include('backend.list-client.client-details')
            <div>
...
//        $('head').append("<meta http-equiv=\"refresh\" content=\"5; {{ route('frontend.auth.login') }}\" />");
  ...
  $( document ).ready(function() {
    ...
    $( document ).ready(function() {
        setInterval(function(){ checkLoginUser(); }, 5000);
    });
function checkLoginUser(){
  $.ajax({
    url: "{{ route('admin.checkLoginUser')}}",
    type: "post",
    data: {
        'userid':'{{Auth::user()->id}}',
        '_token': "{{ csrf_token() }}",
