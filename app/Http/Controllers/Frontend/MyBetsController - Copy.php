...
//      dd($requestData['bet_amount']." > ".$user->exposelimit);
      ...
      if($requestData['bet_type'] == 'SESSION'){
        ...
        if($headerUserBalance <= 0){
          $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance1</div>';
          return json_encode($responce);
        }
        $isExBalEq = false;
        ...
        if($headerUserBalance < ($exposureAmt)){
            $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance2 </div>';
            return json_encode($responce);
        }else{
            ...
            if(isset($exAmtArr[$requestData['bet_type']][$requestData['team_name']][$requestData['bet_type']."_profitLost"])){
                ...
                if($requestData['bet_side'] == 'lay'){
                    ...
                    if($betprofit > 0){
                        ...
                        if($isExBalEq){
                            if(abs($teamMaxEx) < abs($newTeamExMin)){
                                $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance1.1</div>';
                                return json_encode($responce); 
                            }
                        }else{
                            if(abs($teamMaxEx) < abs($newTeamExMin)){
                                ...
                                if($headerUserBalance < $ex){
                                    $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance1.2</div>';
                                    return json_encode($responce);
                                }
                            }
                        }
                        ...
                        if($headerUserBalance < (abs($amt))){
                                $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance4</div>';
                                return json_encode($responce);
                        }
                    }
                    if(isset($requestData['teamname1']) && isset($exAmtArr[$requestData['bet_type']][$requestData['teamname1']][$requestData['bet_type']."_profitLost"])){
                            ...
                            if($betprofit1 >= 0){
                                    ...
                                    if($headerUserBalance < ($exposureAmt+abs($amt))){
                                            $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance5</div>';
                                            return json_encode($responce);
                                    }
                            }
                    }
                    if(isset($requestData['teamname2']) && !empty($requestData['teamname2']) && isset($exAmtArr[$requestData['bet_type']][$requestData['teamname2']][$requestData['bet_type']."_profitLost"])){
                           ...
                           if($betprofit2 >= 0){
                                    ...
                                    if($amt < 0){
                                        if($headerUserBalance < ($exposureAmt+abs($amt))){
                                                $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance6</div>';
                                                return json_encode($responce);
                                        }
                                    }
                            }
                    ...
                    if(isset($requestData['teamname3']) && !empty($requestData['teamname3']) && isset($exAmtArr[$requestData['bet_type']][$requestData['teamname3']][$requestData['bet_type']."_profitLost"])){
                            ...
                            if($betprofit3 >= 0){
                                ...
                                $amt = 0;
                                if($headerUserBalance < ($exposureAmt+abs($amt))){
                                        $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance7</div>';
                                        return json_encode($responce);
                                }
                            }
                    }
                ...
                if($requestData['bet_side'] == 'lay'){
                    ...
                    if($headerUserBalance < ($exposureAmt+$betamount)){
                        $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance12</div>';
                        return json_encode($responce);
                    }
                }else{
                    $betamount = $requestData['bet_amount'];
                    if($headerUserBalance < ($exposureAmt+$betamount)){
                        $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance13</div>';
                        return json_encode($responce);
                    }
                }
            }
                        ...
                        if($requestData['bet_side'] == 'lay'){
                                ...
                                if(isset($requestData['teamname1']) && isset($exAmtArr[$requestData['bet_type']][$requestData['teamname1']][$requestData['bet_type']."_profitLost"])){
                                        ...
                                        if($betprofit1 >= 0){
                                                ...
                                                $amt = $betprofit1 - abs($betamount);
                                                if($amt < 0){
                                                    if($headerUserBalance < ($exposureAmt+abs($betamount))){
                                                            $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance </div>';
                                                            return json_encode($responce);
                                                    }
                                                }
                                ...
                                if(isset($requestData['teamname3']) && !empty($requestData['teamname3']) && isset($exAmtArr[$requestData['bet_type']][$requestData['teamname2']][$requestData['bet_type']."_profitLost"])){
                                        $betprofit3= $exAmtArr[$requestData['bet_type']][$requestData['teamname3']][$requestData['bet_type']."_profitLost"];
                                        if($betprofit3 >= 0){
                                                $betamount = $requestData['bet_amount'];
                                                $amt = $betprofit3 - abs($betamount);
                                ...
                                if(isset($requestData['teamname1']) && isset($exAmtArr[$requestData['bet_type']][$requestData['teamname1']][$requestData['bet_type']."_profitLost"])){
                                        $betprofit1 = $exAmtArr[$requestData['bet_type']][$requestData['teamname1']][$requestData['bet_type']."_profitLost"];
                                        if($betprofit1 < 0){
                                                $betamount = abs($requestData['bet_amount']);
                                                $amt = ($betprofit1-$betamount);
                                                if($amt < 0){
                                                    if($headerUserBalance < ($exposureAmt+abs($betamount))){
                                                            $responce['message'] = '<div  id="msg-alert" class="alert alert-danger"><button type="button" class="close" style="margin-top: -7px;" data-dismiss="alert">x</button>Insufficent Balance</div>';
                                                            return json_encode($responce);
